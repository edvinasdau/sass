...
<body>
	<div class="container-fluid">
		<div class="row virsus">
			<div class="col bloom">Bloom</div>
			<div class="col f">
				<button type="button" class="myg btn btn-success">Home</button>
				<button type="button" class="myg btn">Service</button>
				<button type="button" class="myg btn">Portfolio</button>
				<button type="button" class="myg btn">Contact</button>
			</div>
		</div>
	</div>
